...
![二叉树](./assets/2025-11-24_23-12-06.png)
...
public class LeetCode_102 {
  ...
  public static class TreeNode<E> {
    ...
    public TreeNode(TreeNode<E> left, E val, TreeNode<E> right) {
      this.left = left;
      this.val = val;
      this.right = right;
    }
  ...
  public <E> List<List<E>> levelOrder(TreeNode<E> root) {
    List<List<E>> result = new ArrayList<>();
    if (root == null) {
      return result;
    }

    // LinkedListQueue<TreeNode<E>> queue = new LinkedListQueue<>();
    // ArrayQueue<TreeNode<E>> queue = new ArrayQueue<>(9);
  ...
  public static void main(String[] args) {
    ...
    List<List<Integer>> result = new LeetCode_102().levelOrder(root);
