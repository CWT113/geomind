...
public static void main(String[] args) {
  ...
  List<Integer> integers = new LeetCode_144().preorderTraversal(root);
...
public static void main(String[] args) {
  ...
  List<Integer> integers = new LeetCode_94().inorderTraversal(root);
  for (Integer i : integers) {
    System.out.println(i);
  }
}
...
public static void main(String[] args) {
  ...
  List<Integer> integers = new LeetCode_145().postorderTraversal(root);
  for (Integer i : integers) {
    System.out.println(i);
  }
}
