  ...
  "/frontend/vue/": [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "dayjs", link: "/frontend/vue-utils/dayjs.md" },
        { text: "ECharts", link: "/frontend/vue-utils/ECharts.md" },
        { text: "alasql", link: "/frontend/vue-utils/alasql.md" },
        { text: "LZ-String", link: "/frontend/vue-utils/LZ-String.md" },
        { text: "Pubsub-JS", link: "/frontend/vue-utils/Pubsub-JS.md" },
        { text: "Websocket", link: "/frontend/vue-utils/WebSocket.md" },
        { text: "localForAge", link: "/frontend/vue-utils/localForAge.md" },
        { text: "文字转语音", link: "/frontend/vue-utils/文字转语音.md" },
        {
          text: "西瓜视频播放器",
          link: "/frontend/vue-utils/西瓜视频播放器.md"
        },
        {
          text: "vue-esign手写签字",
          link: "/frontend/vue-utils/vue-esign手写签字.md"
        }
      ]
    }
  ]
