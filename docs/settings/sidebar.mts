  ...
  "/backend/java/jdbc/": [
    {
      text: "基础篇",
      items: [
        { text: "基础使用", link: "/backend/java/jdbc/基础使用.md" },
        { text: "核心API", link: "/backend/java/jdbc/核心API.md" },
        {
          text: "PreparedStatement",
          link: "/backend/java/jdbc/PreparedStatement.md"
        }
      ]
    },
    {
      text: "进阶篇",
      items: [
        { text: "JDBC扩展", link: "/backend/java/jdbc/JDBC扩展.md" },
        { text: "连接池", link: "/backend/java/jdbc/连接池.md" }
      ]
    },
    {
      text: "高级篇",
      items: [
        { text: "工具类封装", link: "/backend/java/jdbc/工具类封装.md" },
        { text: "DAO封装", link: "/backend/java/jdbc/DAO封装.md" },
        { text: "事务", link: "/backend/java/jdbc/事务.md" }
      ]
    }
  ],
