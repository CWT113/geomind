...
[`BingMapsImageryProvider↗`](https://cesium.com/learn/cesiumjs/ref-doc/BingMapsImageryProvider.html?classFilter=BingMapsImageryProvider) 用于加载 BingMap 提供的地图，但是在使用前需要到 BingMap 官网 [申请key↗](https://www.bingmapsportal.com/Application#)。
...
![](./assets/GridImageryProvider.png)
