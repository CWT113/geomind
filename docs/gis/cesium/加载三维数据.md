...
### [ArcGIS](https://cesium.com/learn/cesiumjs/ref-doc/ArcGisMapServerImageryProvider.html) 影像图
...
模型地址："Cesium-1.116\Apps\SampleData\models\CesiumAir\Cesium_Air.glb"

```js
var position = Cesium.Cartesian3.fromDegrees(116.39, 38.9, 400.0);
