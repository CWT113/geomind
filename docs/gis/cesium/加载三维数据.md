...
var tdtImageryProvider = new Cesium.UrlTemplateImageryProvider({
  ...
  // url: "http://t{s}.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&tk=da7665c4b8e7593a2cb6bd910400a71f",
...
[ArcGISTiledElevationTerrainProvider](https://cesium.com/learn/cesiumjs/ref-doc/ArcGISTiledElevationTerrainProvider.html?classFilter=TerrainProvider) 通过镶嵌高度贴图生成三维地形地图。
...
CesiumTerrainProvider 用于访问 Cesium 提供的 terrain 地形地图。
...
EllipsoidTerrainProvider 感觉像是平面的地形，并不算得上是真三维地形？？
