...
上面示例中 `Person` 类没有使用 `extends` 关键字，但是它其实是继承了 `Object` 类的。

下图是`Object`，`Person`、`Student` 、`Teacher` 四个类的继承树：

<img src="E:\Github.Projects\Alikaid\docs\java\basic\assets\继承树.png" alt="image-20240702195502623" style="zoom: 50%;" />
